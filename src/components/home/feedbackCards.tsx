...
export function Feedback({titleName, desc, city, image}:Text): JSX.Element {
    return (
        <div className="select-none">
            <div className="w-[365px] h-max flex flex-col mx-auto border py-5 px-5 rounded-md shadow-fdbcard mb-10">
                <div className="mb-4">
                    <img className="w-14 lg:w-16" src="src/assets/feedback/quotes.png" alt="" />
                </div>
